 ...
 */
public class ItemDyeArmor extends ItemArmor {

    public ItemDyeArmor(String unlocalizedName, ArmorMaterial material, String armorType, EntityEquipmentSlot equipmentSlotIn) {
