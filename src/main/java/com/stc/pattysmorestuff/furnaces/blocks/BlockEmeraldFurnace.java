package com.stc.pattysmorestuff.furnaces.blocks;
...
public class BlockEmeraldFurnace extends BlockContainer {
    ...
    public BlockEmeraldFurnace(String name, boolean isBurning) {
        super(Material.IRON);
    ...
    {
        return Item.getItemFromBlock(ModFurnaces.emerald_furnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModFurnaces.emerald_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.emerald_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModFurnaces.emerald_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.emerald_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
