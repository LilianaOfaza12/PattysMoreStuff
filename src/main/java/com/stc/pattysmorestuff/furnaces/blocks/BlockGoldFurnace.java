...
public class BlockGoldFurnace extends BlockContainer {
    ...
    {
        return Item.getItemFromBlock(ModFurnaces.gold_furnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModFurnaces.gold_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.gold_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModFurnaces.gold_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.gold_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
