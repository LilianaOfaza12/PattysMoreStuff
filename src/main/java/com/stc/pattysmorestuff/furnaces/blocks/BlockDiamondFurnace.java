...
public class BlockDiamondFurnace extends BlockContainer {
    ...
    {
        return Item.getItemFromBlock(ModFurnaces.diamond_furnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModFurnaces.diamond_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.diamond_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModFurnaces.diamond_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.diamond_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
