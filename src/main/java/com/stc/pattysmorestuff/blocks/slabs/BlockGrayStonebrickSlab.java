 ...
 */
public abstract class BlockGrayStonebrickSlab extends BlockSlab {

    public BlockGrayStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_gray_slab_half);
    }
