 ...
 */
public abstract class BlockGraySlab extends BlockSlab {


    public BlockGraySlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_gray_slab_half);
    }
