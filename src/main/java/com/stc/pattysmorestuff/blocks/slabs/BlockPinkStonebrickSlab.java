 ...
 */
public abstract class BlockPinkStonebrickSlab extends BlockSlab{

    public BlockPinkStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_pink_slab_half);
    }
