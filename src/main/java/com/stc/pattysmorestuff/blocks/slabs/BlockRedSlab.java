 ...
 */
public abstract class BlockRedSlab extends BlockSlab {


    public BlockRedSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_red_slab_half);
    }
