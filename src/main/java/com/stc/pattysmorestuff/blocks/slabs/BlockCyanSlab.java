 ...
 */
public abstract class BlockCyanSlab extends BlockSlab {


    public BlockCyanSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_cyan_slab_half);
    }
