 ...
 */
public abstract class BlockMagentaSlab extends BlockSlab {


    public BlockMagentaSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_magenta_slab_half);
    }
