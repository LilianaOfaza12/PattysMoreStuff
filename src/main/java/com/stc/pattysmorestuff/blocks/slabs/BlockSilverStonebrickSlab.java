 ...
 */
public abstract class BlockSilverStonebrickSlab extends BlockSlab {

    public BlockSilverStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_silver_slab_half);
    }
