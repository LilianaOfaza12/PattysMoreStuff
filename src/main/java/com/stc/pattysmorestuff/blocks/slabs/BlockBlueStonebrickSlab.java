 ...
 */
public abstract class BlockBlueStonebrickSlab extends BlockSlab {

    public BlockBlueStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_red_slab_half);
    }
