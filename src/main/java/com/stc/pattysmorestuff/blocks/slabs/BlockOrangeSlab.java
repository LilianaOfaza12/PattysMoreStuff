 ...
 */
public abstract class BlockOrangeSlab extends BlockSlab {


    public BlockOrangeSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_orange_slab_half);
    }
