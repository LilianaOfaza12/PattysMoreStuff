 ...
 */
public abstract class BlockSilverSlab extends BlockSlab {


    public BlockSilverSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_silver_slab_half);
    }
