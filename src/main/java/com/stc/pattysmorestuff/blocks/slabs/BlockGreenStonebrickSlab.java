 ...
 */
public abstract class  BlockGreenStonebrickSlab extends BlockSlab{

    public BlockGreenStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_green_slab_half);
    }
