 ...
 */
public abstract class BlockPinkSlab extends BlockSlab {


    public BlockPinkSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_pink_slab_half);
    }
