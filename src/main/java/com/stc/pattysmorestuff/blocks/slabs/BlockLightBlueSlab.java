 ...
 */
public abstract class BlockLightBlueSlab extends BlockSlab {


    public BlockLightBlueSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_light_blue_slab_half);
    }
