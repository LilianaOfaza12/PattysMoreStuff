 ...
 */
public abstract class BlockLightBlueStonebrickSlab extends BlockSlab {

    public BlockLightBlueStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_light_blue_slab_half);
    }
