 ...
 */
public abstract class BlockWhiteStonebrickSlab extends BlockSlab {

    public BlockWhiteStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_white_slab_half);
    }
