 ...
 */
public abstract class BlockLimeSlab extends BlockSlab {


    public BlockLimeSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_lime_slab_half);
    }
