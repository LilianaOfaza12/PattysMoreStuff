 ...
 */
public abstract class BlockYellowStonebrickSlab extends BlockSlab {

    public BlockYellowStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_yellow_slab_half);
    }
