 ...
 */
public abstract class BlockCyanStonebrickSlab extends BlockSlab {

    public BlockCyanStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_cyan_slab_half);
    }
