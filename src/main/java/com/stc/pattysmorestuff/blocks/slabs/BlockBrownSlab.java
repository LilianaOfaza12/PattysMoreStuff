 ...
 */
public abstract class BlockBrownSlab extends BlockSlab {


    public BlockBrownSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_brown_slab_half);
    }
