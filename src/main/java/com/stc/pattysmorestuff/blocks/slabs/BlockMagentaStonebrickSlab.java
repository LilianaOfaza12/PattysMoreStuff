 ...
 */
public abstract class BlockMagentaStonebrickSlab extends BlockSlab {

    public BlockMagentaStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_magenta_slab_half);
    }
