 ...
 */
public abstract class BlockBlackSlab extends BlockSlab {


    public BlockBlackSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.dye_black_slab_half);
    }
