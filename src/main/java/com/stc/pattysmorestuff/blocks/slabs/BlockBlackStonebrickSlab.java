 ...
 */
public abstract class BlockBlackStonebrickSlab extends BlockSlab {

    public BlockBlackStonebrickSlab(String unlocalizedName) {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(ModBlocks.stonebrick_black_slab_half);
    }
