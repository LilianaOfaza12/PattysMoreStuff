...
public class BlockObsidianFurnace extends BlockContainer {
    ...
    {
        return Item.getItemFromBlock(ModFurnaces.obsidian_furnace);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, ModFurnaces.obsidian_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.obsidian_furnace_active.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, ModFurnaces.obsidian_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, ModFurnaces.obsidian_furnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
