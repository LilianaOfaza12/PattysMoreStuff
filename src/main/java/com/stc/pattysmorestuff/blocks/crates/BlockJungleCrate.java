 ...
 */
public class BlockJungleCrate extends BlockContainer {

    public BlockJungleCrate(String name)
    {
        super(Material.WOOD);
    ...
    public ILockableContainer getContainer(World p_189418_1_, BlockPos p_189418_2_, boolean p_189418_3_)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityJungleCrate)tileentity;
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityJungleCrate)
            {
                i = ((TileEntityJungleCrate)tileentity).numPlayersUsing;
            }
