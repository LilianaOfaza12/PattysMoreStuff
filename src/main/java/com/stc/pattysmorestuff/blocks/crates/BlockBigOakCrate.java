package com.stc.pattysmorestuff.blocks.crates;
...
public class BlockBigOakCrate extends BlockContainer {
    ...
    public BlockBigOakCrate(String name)
    {
        super(Material.WOOD);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            if (tileentity instanceof TileEntityBigOakCrate)
            {
                ((TileEntityBigOakCrate)tileentity).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public ILockableContainer getContainer(World p_189418_1_, BlockPos p_189418_2_, boolean p_189418_3_)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityBigOakCrate)tileentity;
    ...
    {
        return new TileEntityBigOakCrate();
    }
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityBigOakCrate)
            {
                i = ((TileEntityBigOakCrate)tileentity).numPlayersUsing;
            }
