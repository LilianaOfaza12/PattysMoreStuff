 ...
 */
public class BlockAcaciaCrate extends BlockContainer {

    public BlockAcaciaCrate(String name)
    {
        super(Material.WOOD);
    ...
    public ILockableContainer getContainer(World p_189418_1_, BlockPos p_189418_2_, boolean p_189418_3_)
    {
        ...
        {
            ILockableContainer ilockablecontainer = (TileEntityAcaciaCrate)tileentity;
    ...
    public int getWeakPower(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityAcaciaCrate)
            {
                i = ((TileEntityAcaciaCrate)tileentity).numPlayersUsing;
            }
