 ...
 */
public class EntityStuffTheChickenRender extends RenderBiped {

    protected ResourceLocation TwiistsGaming;

    public EntityStuffTheChickenRender(ModelBiped par1ModelBase, float parShadowSize) {
    ...
    protected void preRenderCallback(EntityLivingBase entity, float f) {
        preRenderCallbackTG((EntityStuffTheChicken) entity, f);

    }

    protected void preRenderCallbackTG(EntityStuffTheChicken entity, float f)
