...
public class ItemChocolateMilk extends ItemFood {
    ...
    public ItemChocolateMilk(String name, int hunger, float saturation, boolean isWolfFood) {
        super(hunger, saturation, isWolfFood);
        this.setMaxStackSize(ConfigPreInit.chocolateMilkBottleStackSize);
    ...
    public ItemChocolateMilk addDefaultSpeedPotionEffect() {
        setAlwaysEdible();
