 ...
 */
public class ItemStarPaxel extends ItemTool {
    ...
    public ItemStarPaxel(String name, ToolMaterial materialIn) {
        super(1.5F, -3.0F, materialIn, EFFECTIVE_ON);
    ...
    protected ItemStarPaxel(Item.ToolMaterial material, float damage, float speed)
    {
    ...
    public float getStrVsBlock(ItemStack stack, IBlockState state)
    {
        ...
        else
        {
            ...
            return material != Material.IRON && material != Material.ANVIL && material != Material.ROCK && material != Material.WOOD && material != Material.PLANTS && material != Material.VINE && material != Material.PLANTS && material != Material.VINE && material != Material.CORAL && material != Material.LEAVES && material != Material.GOURD? super.getStrVsBlock(stack, state) : this.efficiencyOnProperMaterial;
