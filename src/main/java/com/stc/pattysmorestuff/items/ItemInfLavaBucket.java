...
public class ItemInfLavaBucket extends Item {
    ...
    public ItemInfLavaBucket(String name, Block containedBlockIn) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add("This allows you to place unlimited amounts of lava!");
    }
        ...
        else
        {
            ...
            else if (flag)
            {
                ...
                else
                {
                    ...
                    return new ActionResult(EnumActionResult.SUCCESS, this.fillBucket(itemstack, playerIn, ModItems.inf_lava_bucket));
            ...
            else
            {
                ...
                {
                    playerIn.addStat(StatList.getObjectUseStats(this));
                    return !playerIn.capabilities.isCreativeMode == false ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(ModItems.inf_lava_bucket)) : new ActionResult(EnumActionResult.SUCCESS, itemstack);
                }
                else
                {
                    return new ActionResult(EnumActionResult.FAIL, itemstack);
    ...
    public boolean tryPlaceContainedLiquid(@Nullable EntityPlayer player, World worldIn, BlockPos posIn)
    {
        ...
        else
        {
            ...
            {
                if (worldIn.provider.doesWaterVaporize() && this.containedBlock == Blocks.FLOWING_LAVA)
                {
                    int l = posIn.getX();
                    int i = posIn.getY();
                    int j = posIn.getZ();
