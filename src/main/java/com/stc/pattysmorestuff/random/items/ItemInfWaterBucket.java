    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else if (flag)
            {
                ...
                else
                {
                    ...
                    Material material = iblockstate.getMaterial();
                        ...
                        return new ActionResult(EnumActionResult.SUCCESS, this.fillBucket(itemstack, playerIn, ModRandomItems.inf_water_bucket));
            ...
            else
            {
                ...
                {
                    playerIn.addStat(StatList.getObjectUseStats(this));
                    return !playerIn.capabilities.isCreativeMode == false ? new ActionResult(EnumActionResult.SUCCESS, new ItemStack(ModRandomItems.inf_water_bucket)) : new ActionResult(EnumActionResult.SUCCESS, itemstack);
                }
                else
                {
                    return new ActionResult(EnumActionResult.FAIL, itemstack);
