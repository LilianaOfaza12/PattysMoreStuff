...
public class WorldGen implements IWorldGenerator {
    ...
    public WorldGen() {
        dye_ore = new WorldGenMinable(ModBlocks.dye_ore.getDefaultState(), ConfigPreInit.oreBlockCount, BlockMatcher.forBlock(Blocks.STONE));
        ender_pearl_ore = new WorldGenMinable(ModBlocks.ender_pearl_ore.getDefaultState(), ConfigPreInit.oreEnderBlockCount, BlockMatcher.forBlock(Blocks.STONE));
    }
